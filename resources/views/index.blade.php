    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                ...
                <p>Straight from local farmers to your table. No middlemen, just the freshest vegetables, dairy, and meat at fair prices.</p>
            ...
            <div class="category-grid">
                ...
                <div class="category-card">
                    <div class="category-img">
                        <img src="https://images.unsplash.com/photo-1542838132-92c53300491e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Fresh Vegetables">
                    </div>
                    <div class="category-info">
                        <h3>Seasonal Vegetables</h3>
                        <p>Harvested at peak freshness, delivered within 24 hours</p>
                        <a href="#" class="cta-button" style="display: inline-block; padding: 0.5rem 1.25rem; font-size: 0.9rem;">Browse</a>
                    </div>
                </div>
                ...
                <div class="category-card">
                    <div class="category-img">
                        <img src="https://images.unsplash.com/photo-1550583724-b2692b85b150?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Dairy Products">
                    </div>
                    <div class="category-info">
                        <h3>Farm Dairy</h3>
                ...
                <div class="category-card">
                    <div class="category-img">
                        <img src="https://images.unsplash.com/photo-1666013942642-b7b54ecafd7d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Fresh Meat">
                    </div>
                    <div class="category-info">
                        <h3>Ethical Meat</h3>
