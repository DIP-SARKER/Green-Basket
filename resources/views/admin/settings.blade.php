...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="" class="active"><i class="fas fa-cog"></i> <span class="nav-text">Settings</span></a></li>
        </ul>
    </aside>
            ...
            <div class="settings-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="storeName" class="form-control" value="GreenBasket" placeholder="Enter store name">
                    </div>
                    
                    <div class="form-group">
                        <label for="storeEmail">Store Email</label>
                        <input type="email" id="storeEmail" class="form-control" value="info@greenbasket.com" placeholder="Enter store email">
                    </div>
                    
                    <div class="form-group">
                        <label for="storePhone">Store Phone</label>
                        <input type="tel" id="storePhone" class="form-control" value="+880 1234 567890" placeholder="Enter store phone">
                    </div>
    ...
    <tr>
        <td>
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="https://randomuser.me/api/portraits/men/15.jpg" alt="Dip Sarker" class="staff-avatar">
                <div>
    ...
    <tr>
        <td>
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="https://randomuser.me/api/portraits/men/16.jpg" alt="Md. Mamun Ur Rashid Hridoy" class="staff-avatar">
                <div>
    ...
    <tr>
        <td>
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="https://randomuser.me/api/portraits/men/33.jpg" alt="Md. Mashiur Rrahman" class="staff-avatar">
                <div>
    ...
    <tr>
        <td>
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="https://randomuser.me/api/portraits/men/44.jpg" alt="Md. Sakib Khan" class="staff-avatar">
                <div>
    ...
    <tr>
        <td>
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <img src="https://randomuser.me/api/portraits/women/21.jpg" alt="Sumaiya Tabassum Prome" class="staff-avatar">
                <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            resetBtn.addEventListener('click', function() {
                if(confirm('WARNING: This will permanently delete all store data including products, orders, and customer information. Are you absolutely sure?')) {
